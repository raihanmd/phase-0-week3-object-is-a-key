...
?Sepatu brand Stacattu seharga 1_500_000
?Baju brand Zoro seharga 500_000
?Baju brand H&N seharga 250_000
?Sweater brand Uniklooh seharga 175_000
?Casing Handphone seharga 50_000
...
function shoppingTime(memberId, money) {
  ...
  Object.keys(ITEMS).map((item) => {
    if (changeMoney >= ITEMS[item]) {
      changeMoney -= ITEMS[item];
      purchased.push(item);
    }
  });
